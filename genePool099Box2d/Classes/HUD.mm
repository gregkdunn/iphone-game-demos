...
- (id) init
{
	...
	if(self != nil)
	{
		...
		scoreBoard = [[HUDComponent alloc]initWithValue:[Storage getCurrentGameScore] andLabel:@"Score:"  andComponentFormat:@"%@ %06i" andFontName:@"Arial" andFontSize:12];
		scoreBoard.position = ccp(70, 300);					  
		[self addChild:scoreBoard];

		healthBar = [[HUDComponent alloc]initWithValue:[Storage getCurrentHealth] andLabel:@"Health:"  andComponentFormat:@"%@ %03i" andFontName:@"Arial" andFontSize:12];
		...
		energyBar = [[HUDComponent alloc]initWithValue:100 andLabel:@"Energy:"  andComponentFormat:@"%@ %03i" andFontName:@"Arial" andFontSize:12];
