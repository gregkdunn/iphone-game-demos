...
@property (readwrite, assign) Vector3D *jsVector;

-(id)initWithRect:(CGRect)rect;
-(id)initWithRect:(CGRect)rect andBase:(CCSprite *)jsBaseFile;
-(id)initWithRect:(CGRect)rect andBase:(CCSprite *)jsBaseFile andNub:(CCSprite *)jsNubFile;
